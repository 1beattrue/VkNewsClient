...
fun MainScreen() {
    val snackbarHostState = remember {
        SnackbarHostState() // без этого при обращении к snackbarHostState снова вызовется функция MainScreen
        // поэтому лучше все state'ы создавать таким образом
    }

    Log.d("MainScreen", snackbarHostState.toString())
